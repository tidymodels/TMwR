...
Between the `recipes` package and other package that extend `recipes`, there are over 100 available steps. All possibl recipe steps are enumerated TBD. `recipes` provides a rich data manipulation environment for pre-processing and transforming data prior to modeling. 
