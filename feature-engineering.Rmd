...
The chapter uses the R objects created in previous chapters, summarized in Section \@ref(splitting-summary).
...
TODO remove log from y and add to `Gr_Liv_Area`; other changes about pre-logging
