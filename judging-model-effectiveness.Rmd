...
**TODO** this is not true; mention that it is df based, not vector based. 
...
```
The output above shows the standard format of the output of `yardstick` functions. The `.estimator` is usually "standard". The definition of "standard" depends on the method; consult the function help pages for details. Examples of non-standard  will be shown below for classification. **TODO** better description of the estimator column. 
...
**TODO** talk more about estimator here; multi-class and binary for the conventional equations. 
...
but macro-averaging methods are also available: 
