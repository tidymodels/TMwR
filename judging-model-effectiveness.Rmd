...
To illustrate other aspects of these functions, we will switch to a different example. The `modeldata` package contains example predictions from a test data set with two classes ("Class1" and "Class2"):
