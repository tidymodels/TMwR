...
The `two_class_curve` object can be used in a `ggplot` call to visualize the curve. There is an `autoplot()` method that will take care of the details. This code produces the plot in Figure \@ref(fig:):
