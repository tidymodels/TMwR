...
In an effort to make argument specification less painful, `r pkg(parsnip)` uses common argument names within and between packages. Table \@ref(tab:parsnip-args) shows, for random forests, `r pkg(parsnip)` models use.
...
```{r model-pred-types, echo = FALSE, results = "asis"}
  ...
  kable(
    caption = "The different return values for glmnet prediction types.",
    label = "predict-types"
  ) %>% 
  kable_styling(full_width = FALSE)
```
