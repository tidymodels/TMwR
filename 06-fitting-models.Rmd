...
\begin{tabular}{llll}
\toprule
Argument Type                  & ranger        & randomForest & sparklyr                  \\ \midrule
number of sampled predictors   & {\tt mtry}          & {\tt mtry}         & {\tt feature\_subset\_strategy} \\
number of trees                & {\tt num.trees}     & {\tt ntree}        & {\tt num\_trees}                 \\
number of data points to split & {\tt min.node.size} & {\tt nodesize}     & {\tt min\_instances\_per\_node} \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{ll}
\toprule
Argument Type                  & parsnip \\ \midrule
number of sampled predictors   & {\tt mtry}    \\
number of trees                & {\tt trees}   \\
number of data points to split & {\tt min\_n}   \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}ll@{}}
\toprule
Type of Prediction       & Returns a:                      \\ \midrule
numeric                  & numeric matrix                  \\
class                    & character matrix                \\
probability (2 classes)  & numeric matrix (2nd level only) \\
probability (3+ classes) & 3D numeric array (all levels)   \\ \bottomrule
\end{tabular}
\end{table}
...
```{r model-pred-info, eval = FALSE, results = "asis", echo = FALSE}
  tribble(
...
\begin{tabular}{ll}
\toprule
{\tt type} value      & column name(s)                         \\ \midrule
{\tt 'numeric'}  & {\tt .pred}                           \\
{\tt 'class'}    & {\tt .pred\_class}                     \\
{\tt 'prob'}     & {\tt .pred\_class\_levels}              \\
{\tt 'conf\_int'} & {\tt .pred\_lower}, {\tt .pred\_upper} \\
{\tt 'pred\_int'} & {\tt .pred\_lower}, {\tt .pred\_upper} \\ \bottomrule
\end{tabular}
\end{table}
...
knitr::include_graphics("premade/addin.png")
```
