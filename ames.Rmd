...
This chapter introduced a data set used in later chapters to demonstrate tidymodels syntax. The important code snippets that will carry forward in subsequent chapters is:
