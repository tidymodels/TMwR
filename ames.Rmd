...
The Ames housing data set [@ames] is an excellent teaching resource and will be used in several parts of this book. It contains data on `r nrow(ames)` properties in Ames Iowa, including columns related to 
