...
1. Decorrelating predictors may not help improve performance. However, fewer correlated predictors can improve the estimation of variance importance scores. Essentially, the selection of highly correlated predictors is almost random. 
