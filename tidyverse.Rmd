...
The full set of strategies and tactics for writing R code in the tidyverse style can be found at the websites [`https://design.tidyverse.org`](https://design.tidyverse.org/) and [`https://principles.tidyverse.org`](https://principles.tidyverse.org/). These sections describe a few ideas and their motivation. 
 ...
 * In computational chemistry, the structural descriptor format (SDF) is a tool to take chemical structures and encode them in a format that is computational efficient to work with. 
