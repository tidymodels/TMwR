...
Let's look at an example. Suppose you are interested in the logarithm of the ratio of the sepal length to the petal length in irises. To those new to R and/or coming from other programming languages, a loop might seem like a good option:
