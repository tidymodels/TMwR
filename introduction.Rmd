...
```{r descr-examples, echo = FALSE, fig.cap = "Two examples of how descriptive models can be used to illustrate specific patterns.", out.width = '80%', dev = "png", fig.height = 8, warning = FALSE, message = FALSE}
...
```{r data-science-model, echo = FALSE, out.width = '80%', fig.cap = "The data science process (from R for Data Science)."}

if (knitr:::is_html_output()) {
  knitr::include_graphics("figures-premade/data-science-model.svg")
} else {
   knitr::include_graphics("figures-premade/data-science-model.pdf")
}
```
...
```{r modeling-process, echo = FALSE, out.width = '100%', fig.width=8, fig.height=3, fig.cap = "A schematic for the typical modeling process (from Feature Engineering and Selection).", warning = FALSE}
...
```{r monolog, echo = FALSE, results = 'as-is'}
monolog <- 
  tribble(
    ...
    "Feature Engineering", " ",
    "Daily weather records should probably be summarized into daily measurements. ",
    "Model Fitting", "1",
