...
png("ames.png", width = 480 * ames_ratio)
print(all_ames)
dev.off()
...
# guide inset in plot
png("mitchell.png", width = 480 * mitchell_ratio)
print(mitchell)
...
# guide inset in plot
png("timberland.png", width = 480 * timberland_ratio)
print(timberland)
...
# guide inset in plot
png("dot_rr.png", width = 480 * dot_rr_ratio)
print(dot_rr)
...
# guide inset in plot
png("crawford.png", width = 480 * crawford_ratio)
print(crawford)
...
# guide inset in plot
png("northridge.png", width = 480 * northridge_ratio)
print(northridge)
