...
The `autoplot()` method shows confidence intervals for each model in order of best-to-worst. In this chapter, we'll focus on the coefficient of determination (a.k.a. R<sup>2</sup>). The following code generates Figure \@ref(fig:workflow-set-r-squared):
...
#| echo = FALSE,
#| fig.cap = "Confidence intervals for the coefficient of determination for four different models.",
#| fig.alt = "Confidence intervals for the coefficient of determination for four different models. The random forest model has the best results and its intervals do not overlap with the intervals of the other models. "
```
...
```{r rsquared-resamples, ref.label = "compare-rsq-plot"}
#| fig.height=4,
#| echo = FALSE,
#| fig.cap = "A plot connecting the resample statistics across models.",
...
```{r four-posteriors, ref.label = "compare-group-posteriors-res"}
#| echo = FALSE,
#| fig.cap = "Posterior distributions for the coefficient of determination for four different models.",
#| fig.alt = "Posterior distributions for the coefficient of determination for four different models. The distribution corresponding to random forest is largest and has little overlap with the other model's posteriors."
```
...
Figure \@ref(fig:credible-intervals)
Figure \@ref(fig:rsquared-resamples)
...
```{r posterior-difference, ref.label = "compare-lm-difference-posterior"}
#| fig.height = 3,
#| fig.cap = "The posterior distribution for the difference in the coefficient of determination.",
...
#| fig.height = 3, 
#| echo = FALSE,
#| fig.cap = "The probability of practical equivalence to the random forest model.",
