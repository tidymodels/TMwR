...
The same helpful functions are available for this object to interrogate the results and, in fact, the basic `autoplot()` method shown in Figure \@ref(fig:workflow-set-ranks)[^nnetnote] produces trends similar to Figure \@ref(fig:workflow-sets-autoplot). This is produced by:
