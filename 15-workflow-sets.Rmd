...
```{r conc-save-1, include = FALSE}
concrete_raw <- concrete
```
...
```{r conc-save-2, include = FALSE}
concrete_summary <- concrete
save(concrete_raw, concrete_summary, file = "concrete_check.RData")
```
