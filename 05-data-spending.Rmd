...
To get the training and testing data, the same syntax is used: 
...
Section \@ref(validation) will demonstrate how to use the `ames_val_split` for resampling and model optimization
