...
pkg_list <- c("AmesHousing", "bookdown", "broom", "dials", "discrim", "dplyr",
              "ggplot2", "infer", "kableExtra", "knitr", "parsnip", "patchwork",
              "purrr", "recipes", "rlang", "rsample", "splines", "tibble",
              "tidymodels", "tidyverse", "tune", "workflows", "yardstick")
library(sessioninfo)
