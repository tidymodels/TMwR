...
[^dalexlevels]: Notice that this package for model explanations focuses the **level** of categorical predictors in this type of output, like `Bldg_Type = 3` for duplex and `Neighborhood = 1` for North Ames.
...
```{r explain-build-type, echo=FALSE}
...
```{r explain-build-type-facet, echo=FALSE}
as_tibble(pdp_liv$agr_profiles) %>%
