...
#| fig.alt = "Shapley additive explanations from the random forest model for a duplex property. Gross living area and year built have the largest contributions."
```
...
This code produces Figure \@ref(fig:building-type-profiles).
