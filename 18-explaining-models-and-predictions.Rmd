...
- **derived features**, such as those created via dimensionality reduction (Chapter \@ref(dimensionality)) or spline terms, as in this example.
...
Shape factors are among the most important features for predicting bean type, as are minor axis length and roundness.
