...
There are two ways of thinking about the model workflow. Figure \@ref(fig:bad-workflow) illustrates the _incorrect_ method would be to think of the PCA preprocessing step as _not being part of the modeling process_.

```{r bad-workflow, echo = FALSE, out.width = '80%', warning = FALSE}
#| fig.cap = "An incorrect mental model of where model estimation occurs in the data analysis process.",
...
#| fig.cap = "A correct mental model of where model estimation occurs in the data analysis process.",
