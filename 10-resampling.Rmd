...
all_res %>% 
  ...
  kable(
    caption = "Training and test sets performance statstics.",
    label = "rmse-results",
    escape = FALSE
  ) %>% 
...
#| out.width = '85%',
#| warning = FALSE,
#| fig.cap = "A diagram of the data splitting scheme from the initial data split to resampling. ",
...
#| out.width = '70%', 
#| warning = FALSE,
#| fig.cap = "A diagram of V-fold cross-validation data usage (where V equals three).",
...
#| echo = FALSE, 
#| fig.height = 4,
#| fig.cap = "The relationship between the relative variance in performance estimates versus the number of cross-validation repeats.",
...
#| out.width = '80%',
#| warning = FALSE,
#| fig.cap = "A diagram of bootstrapping data usage.",
...
To illustrate, a training set of fifteen samples was resampled with an analysis size of eight samples and an assessment set size of three. The second iteration discards the first training set sample and both data sets shift forward by one. This configuration results in five resamples is shown in Figure\@ref(fig:rolling).

```{r rolling}
#| echo = FALSE,
#| out.width = '65%',
#| warning = FALSE,
#| fig.cap = "The data usage for rolling forecasting origin resampling.",
...
#| fig.width=5,
#| echo = FALSE,
#| fig.cap = "Scatter plots of out-of-sample observed versus predicted values for an Ames regression model. Both axes using log-10 units.",
