 ...
 * **Regression** predicts quantitative variables, such as real numbers like `3.14159` and integers like `42`.

 * **Classification** predicts qualitative variables, such as ordered category sets like "small", "medium", or "large" and unordered category sets like "math", "science", or "history".
