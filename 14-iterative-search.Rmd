...
* `cooling_coef` is the `c` coefficient shown above that can modulate how quickly the acceptance probability decreases over iterations. Larger values of cooling_coef` decrease the probability of accepting a sub-optimal parameter setting.
