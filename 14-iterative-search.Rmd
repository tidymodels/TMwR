...
# Check with:
# Commented out do to different GP model and RNG; will change in later PR
...
nm <- recipes::names0(max(svm_bo$.iter), "gp_candidates_")
...
file.copy(files, "RData")
si <- sessioninfo::session_info()
save(si, file = "RData/si.RData")

save(svm_bo_output, svm_bo, file = "RData/bo_debug.RData")
...
# Check with
# Commented out do to different RNG; will change in later PR:
