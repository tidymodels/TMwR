...
```{r iterative-cells-bo-calcs, echo = FALSE, eval = FALSE}
...
```{r iterative-cells-bo, eval = TRUE}
ctrl <- control_bayes(verbose = TRUE)
...
```{r iterative-cells-sa-calcs, include = FALSE, eval = FALSE}
...
```
```{r iterative-cells-sa, eval = TRUE}
