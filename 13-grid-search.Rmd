...
As previously mentioned in Section \@ref(parallel), parallel processing is an effective method for decreasing training time, especially when models are resampled. This advantage conveys to model tuning with grid search. 
