...
To illustrate how the parallel processing works, consider a situation with 10-fold cross-validation, a grid of none tuning parameter combinations (all on model parameters), and ten worker processes (i.e., cores). 
...
```{r grid-logging-rs, echo = FALSE, message = FALSE, height = 9}
...
```{r grid-logging-all, echo = FALSE, message = FALSE, height = 9}
times_all  %>%
...
```{r grid-par-speed-up, echo = FALSE}
