...
Our work here has used recipes solely inside of a workflow object. For modeling, that is the recommended use. However, for visualization and other activities, a workflow may not be appropriate; more recipe-specific functions may be required. Chapter @dimensionality discusses lower-level APIs for fitting and using recipes. 
